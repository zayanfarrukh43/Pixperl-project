...
// SVG Shield Logo Component updated to Blue Theme
function PixPerlLogo() {
  return (
    <div className="flex items-center gap-2 select-none cursor-pointer group">
      <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-blue-500/10 border border-blue-500/30 flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
        <svg
      ...
      <span className="font-mono font-black tracking-[0.18em] sm:tracking-[0.22em] text-base sm:text-2xl leading-none text-neutral-900">
        PIXPERL
      </span>
    </div>
  );
...
export default function GetQuotePage() {
  ...
  const serviceOptions = [
    ...
    { id: 'hardware_setup', label: 'Systems & Hardware Setup', icon: ShieldIcon },
      ...
      <main className="py-6 sm:py-16 md:py-20 px-3.5 sm:px-6 lg:px-12 max-w-5xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-neutral-100 border border-neutral-200 rounded-full text-[9px] sm:text-[10px] font-mono font-bold tracking-wider sm:tracking-widest text-blue-600 uppercase mb-3 sm:mb-4">
            <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-blue-600 animate-ping shrink-0" />
            <span className="truncate">PIXPERL // ESTIMATOR</span>
          </div>
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-black text-neutral-900 tracking-tight leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-neutral-700 to-neutral-900">
              Surveillance Quote
            </span>
          </h1>
          <p className="mt-2.5 sm:mt-4 text-xs sm:text-sm text-neutral-600 font-normal max-w-xl mx-auto leading-relaxed px-2 sm:px-0">
            Configure your facility specifications below. Our technical team will respond with an official SLA blueprint within 24 hours.
          </p>
        </div>
        ...
        {!isSubmitted && (
          <div className="mb-6 sm:mb-10 max-w-xl mx-auto">
            <div className="flex sm:hidden justify-between items-center text-[11px] font-mono font-bold uppercase text-neutral-500 mb-2 px-1">
              <span className="text-blue-600">Step {currentStep} of 3</span>
            ...
            <div className="hidden sm:flex items-center justify-between text-xs font-mono font-bold uppercase tracking-widest text-neutral-400 mb-2">
              <span className={currentStep >= 1 ? 'text-blue-600' : ''}>01. Requirements</span>
              <span className={currentStep >= 2 ? 'text-blue-600' : ''}>02. Services & Scope</span>
              <span className={currentStep >= 3 ? 'text-blue-600' : ''}>03. Contact Info</span>
            </div>

            <div className="w-full bg-neutral-100 h-1.5 rounded-full overflow-hidden border border-neutral-200">
              <div
                className="bg-blue-600 h-full transition-all duration-500 shadow-[0_0_10px_rgba(37,99,235,0.4)]"
        ...
        <div className="bg-white border border-neutral-200 rounded-xl sm:rounded-2xl p-4 sm:p-8 md:p-10 shadow-xl relative">
          ...
          <AnimatePresence mode="wait">
            {isSubmitted ? (
              ...
              >
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-blue-50 border border-blue-600 text-blue-600 rounded-full flex items-center justify-center mx-auto text-lg sm:text-2xl font-mono font-bold shadow-[0_0_30px_rgba(37,99,235,0.2)]">
                  ✓
                </div>
                <h2 className="text-xl sm:text-3xl font-black text-neutral-900">Quote Request Transmitted</h2>
                <p className="text-xs sm:text-sm text-neutral-600 max-w-md mx-auto font-normal leading-relaxed px-2">
                  Thank you, <strong>{formData.fullName}</strong>. Your request for <strong>{formData.companyName || 'your business'}</strong> has been received by PixPerl.
                </p>
                <div className="p-3 sm:p-4 bg-neutral-50 rounded-xl border border-neutral-200 text-[11px] sm:text-xs font-mono text-neutral-600 inline-block">
                  TICKET ID: <span className="text-blue-600 font-bold">{ticketId}</span>
                </div>
                <div className="pt-2 sm:pt-4">
                  <a
                    href="/"
                    className="inline-block w-full sm:w-auto px-8 py-3.5 bg-neutral-900 text-white font-mono text-xs font-extrabold uppercase tracking-widest rounded-md hover:bg-blue-600 transition-colors active:scale-[0.98]"
                  >
                    Return To Homepage
                  </a>
                </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                {currentStep === 1 && (
                  ...
                  >
                    <h3 className="text-sm sm:text-lg font-mono font-bold text-neutral-900 uppercase tracking-wider border-b border-neutral-200 pb-2.5 sm:pb-3">
                      Step 1: Operation & Facility Parameters
                    </h3>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                      <div>
                        <label className="block text-[11px] sm:text-xs font-mono font-bold text-neutral-600 uppercase mb-1.5 sm:mb-2">
                    ...
                    <div className="pt-2 sm:pt-6 flex justify-end">
                      <button
                        ...
                        className="w-full sm:w-auto px-8 py-3.5 bg-blue-600 text-white font-mono text-xs font-extrabold uppercase tracking-widest rounded-md hover:bg-blue-700 shadow-[0_0_20px_rgba(37,99,235,0.3)] transition-all active:scale-[0.98]"
                      >
                ...
                {currentStep === 2 && (
                  ...
                  >
                    ...
                    <p className="text-[11px] sm:text-xs text-neutral-600 font-mono">Select all modules required for your contract:</p>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleInputChange}
                        placeholder="Mention square footage, existing hardware, specific camera count, or custom integration requests..."
                        className="w-full bg-neutral-50 border border-neutral-200 rounded-md px-3.5 py-3 text-base sm:text-sm text-neutral-900 focus:border-blue-600 focus:bg-white focus:outline-none transition-colors resize-none"
                      />
                    </div>
                    ...
                    <div className="pt-2 sm:pt-6 flex flex-col-reverse sm:flex-row gap-3 sm:gap-0 justify-between items-center">
                      <button
                        ...
                        className="w-full sm:w-auto text-center py-3 sm:py-0 text-xs font-mono font-bold uppercase tracking-widest text-neutral-500 hover:text-neutral-900 transition-colors"
                      >
                        ← Back
                      </button>
                      <button
                ...
                {currentStep === 3 && (
                  ...
                  >
                    ...
                    <div className="p-3 sm:p-4 bg-neutral-50 border border-neutral-200 rounded-xl text-[11px] sm:text-xs font-mono text-neutral-600 space-y-1">
                      <p className="text-blue-600 font-bold mb-1">SUMMARY SPECIFICATION:</p>
                    ...
                    <div className="pt-2 sm:pt-6 flex flex-col-reverse sm:flex-row gap-3 sm:gap-0 justify-between items-center">
                      ...
                      <button
                        type="submit"
                        disabled={loading}
                        className="w-full sm:w-auto px-8 py-3.5 bg-blue-600 text-white font-mono text-xs font-extrabold uppercase tracking-widest rounded-md shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:bg-blue-700 transition-all active:scale-[0.98] disabled:opacity-60"
                      >
